...
Dreambooth requires a placeholder word ```[V]```, called identifier, as in the paper. This identifier needs to be a relatively rare tokens in the vocabulary. The original paper approaches this by using a rare word in T5-XXL tokenizer. For simplicity, here I just use a random word ```lolslimlol``` and hard coded it.. If you want to change that, simply make a change in [this file](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion/blob/main/ldm/data/personalized.py#L10).
...
python scripts/stable_txt2img.py --ddim_eta 0.0 
                                 ...
                                 --prompt "photo of a lolslimlol <class>" 
```

In particular, ```lolslimlol``` is the identifier, which should be replaced by your choice if you happen to change the identifier, and ```<class>``` is the class word ```--class_word``` for training.
...
After training, generated images with prompt ```photo of a lolslimlol container```:

![](assets/photo-of-a-lolslimlol-container-0018.jpg)

Generated images with prompt ```photo of a lolslimlol container on the beach```:

![](assets/photo-of-a-lolslimlol-container-on-the-beach-0017.jpg)

Generated images with prompt ```photo of a lolslimlol container on the moon```:

![](assets/photo-of-a-lolslimlol-container-on-the-moon-0016.jpg)

Some not-so-perfect but still interesting results:

Generated images with prompt ```photo of a red lolslimlol container```:

![](assets/a-red-lolslimlol-container-0021.jpg)

Generated images with prompt ```a dog on top of lolslimlol container```:

![](assets/a-dog-on-top-of-lolslimlol-container-0023.jpg)
